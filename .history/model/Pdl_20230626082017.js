...
const Pdl = sequelize.define(
    "Pdl",
    {
        ...
        bookingAt: {
            ...
            field: "bookingAt",
            get() {
                const datetime = this.getDataValue("bookingAt"); // Sửa đổi thành "bookingAt"
                return moment(datetime).tz("Asia/Bangkok").format("YYYY-MM-DD HH:mm:ss");
            },
            set(value) {
                const utcDatetime = moment.tz(value, "Asia/Bangkok").utc().format("YYYY-MM-DD HH:mm:ss");
                this.setDataValue("bookingAt", utcDatetime); // Sửa đổi thành "bookingAt"
            },
        },
        message: {
