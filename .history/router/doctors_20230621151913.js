...
router.get('/:id/:idl',middlewareVerifyToken.verifyDoctor,doctorController.getDetailSchedule) // lấy lịch theo id

router.post('/insert') // tạo lịch khám (bsi tạo)
router.delete('/delete-schedule/:id') // xóa lịch khám theo id
