...
router.get("/:id",middlewareVerifyToken.verifyToken,userController.getDetailUser); // lay tat ca thong tin user hien thi o trang thong tin user
router.get("/",userController.getAllUser); // lay tat ca thong tin user hien thi o trang thong tin user
router.post(
    "/login",
    body("email").isEmail(),
