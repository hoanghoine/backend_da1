...
const updateUserProfile = async ({
    ...
    try {
        let userUpdating = await User.findByPk(userID)
        ...
        if(userUpdating){
            userUpdating.name = name ?? userUpdating.name
            // console.log(userUpdating.name)
            userUpdating.dob = dob ?? userUpdating.dob
            userUpdating.sex = sex ?? userUpdating.sex
            userUpdating.phoneNumber = phoneNumber?? userUpdating.phoneNumber
            userUpdating.BHYT = BHYT ?? userUpdating.BHYT
            userUpdating.address = address ?? userUpdating.address
            // console.log(userUpdating.address)
            userUpdating.password = hashPassword ?? userUpdating.password 
